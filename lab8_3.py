...
def input_number() -> list:
    """This function enters random lists of numbers"""
    range_number = input('Enter range of number: ')
    number_list=[random.randint(1,int(range_number)**2)for i in range(1,int(range_number)+1)]
